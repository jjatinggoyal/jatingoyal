      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-300 animate-on-scroll opacity-0 transition-opacity duration-700 delay-200">
            A passionate software engineer with a love for clean code and creative solutions.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="animate-on-scroll opacity-0 transition-opacity duration-700 delay-300">
            ...
            <p className="text-slate-600 dark:text-slate-300 mb-6 leading-relaxed">
              I'm inspired by the philosophy and technical work of open-source communities, which has motivated me to start my own projects and contribute to open-source software. Here's a showcase of my work and passion for building meaningful applications.
            </p>
            <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
              When I'm not coding, I enjoy reading technical blogs, experimenting with new technologies, and connecting with fellow developers to exchange ideas and experiences.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-6 animate-on-scroll opacity-0 transition-opacity duration-700 delay-400">
            <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 transform transition-transform hover:-translate-y-1 duration-300">
              ...
              <h3 className="text-xl font-semibold text-slate-800 dark:text-white mb-2">Continuous Learner</h3>
              <p className="text-slate-600 dark:text-slate-400 text-sm">
                Always expanding my skills and knowledge in software development.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 transform transition-transform hover:-translate-y-1 duration-300">
              ...
              <h3 className="text-xl font-semibold text-slate-800 dark:text-white mb-2">Problem Solver</h3>
              <p className="text-slate-600 dark:text-slate-400 text-sm">
                Finding elegant solutions to complex software challenges.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 transform transition-transform hover:-translate-y-1 duration-300">
              ...
              <h3 className="text-xl font-semibold text-slate-800 dark:text-white mb-2">Open Source Enthusiast</h3>
              <p className="text-slate-600 dark:text-slate-400 text-sm">
                Passionate about contributing to and supporting open source.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 transform transition-transform hover:-translate-y-1 duration-300">
              ...
              <h3 className="text-xl font-semibold text-slate-800 dark:text-white mb-2">Team Player</h3>
              <p className="text-slate-600 dark:text-slate-400 text-sm">
                Collaborating effectively to achieve shared development goals.
              </p>
            </div>
          </div>
        </div>
